  ...
  public: {
    Tables: {
      ...
      chat_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "chat_messages_chat_id_user_id_fkey"
            columns: ["chat_id", "user_id"]
            isOneToOne: false
            referencedRelation: "chat_members"
            referencedColumns: ["chat_id", "user_id"]
          },
          {
            foreignKeyName: "chat_messages_reply_to_chat_message_id_fkey"
            columns: ["reply_to_chat_message_id"]
            isOneToOne: false
